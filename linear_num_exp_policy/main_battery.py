...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', action='store', type=str, default='battery1', help="Select dataset between nasa dataset")
    ...
    args = {
        ...
        'site_mu': np.array([[10], [1]]), 'site_Sigma': np.array([[10, 0], [0, 1]]), 'initial_t': 5,
        # Simulation params
        'N': 4, 'M': 3, 'K': 60, 'S': 20, 'C': 3, 's1_limit': 15, 'r_limit': 14, 'd': 1, 'max_T': 5000,
        'prop_mu_mu': 5, 'prop_std_mu': 5, 'prop_mu_sigma': 0, 'prop_std_sigma': 1,
        'num_prop': 100000, 'num_target': 75000, 'ep_tol': 1e-5,
