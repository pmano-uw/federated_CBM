...
if __name__ == '__main__':
    ...
    args = {
        ...
        # Simulation params
        'N': 50, 'M': 5, 'K': 100, 'S': 20, 'C': 3, 's1_limit': 11, 'r_limit': 10, 'd': 1, 'max_T': 5000,
        'prop_mu_mu': 5, 'prop_std_mu': 5, 'prop_mu_sigma': 0, 'prop_std_sigma': 1,
        'num_prop': 100000, 'num_target': 75000, 'ep_tol': 1e-3,
        # Value iteration params
        'c1':  -100, 'c2': -5, 'c3': -0.05, 'max_iter': 5000, 'threshold': 1e-3, 'gamma': 0.99, 'epsilon':1e-3,
        'window': 2,
        # Sampling parameters
